...
window.addEventListener('load', async () => {
    ...
    const isAdmin = await accessControlContract.methods.isAdmin(currentUser).call();
...
async function finalizeResult() {
    ...
    try {
        await resultTallyContract.methods.finalizeResult().send({ from: web3.eth.defaultAccount });
        alert("Election result finalized successfully");
